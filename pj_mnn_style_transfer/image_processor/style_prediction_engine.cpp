...
/* Model parameters */
#define MODEL_NAME   "017_Artistic-Style-Transfer_prediction.mnn"
#define INPUT_NAME   "style_image"
#define OUTPUT_NAME  "mobilenet_conv/Conv/BiasAdd"
...
int32_t StylePredictionEngine::Process(const cv::Mat& original_mat, Result& result)
{
	...
	/* Return the results */
	result.styleBottleneck = output_tensor_info_list_[0].GetDataAsFloat();
